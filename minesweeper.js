window.onload = function() {
   ...
   function burstMP(cell, player) {
      ...
      if (value === -1) {
         ...
         decreaseMines();
         if (player === opponent) {
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/bombdeath.gif");
         } else {
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/bombrevealed.gif");
         }
   ...
   function showScore() {
      if (points === undefined) {
         ...
         document.getElementById("score").innerHTML = "A tua pontuação neste modo de jogo é " + points;
      }
   }
         ...
         if (xhr.readyState === 4 && xhr.status == 200) {
            ...
            if (res.error !== undefined) {
               ...
               for (var i = 0; i < showHonor.length; i++) {
                  ...
                  var textnode = document.createTextNode(" " + showHonor[i].name + " " + showHonor[i].score);
   ...
   function playerLoggedIn() {
      document.getElementById("message_to_player").innerHTML = username + " logged in!";
      return false;
   }

   function playerIsWaiting() {
      console.log("bom dia");
      document.getElementById("message_to_player").innerHTML = "<p>" + username + " está a espera dum adversário...</p>" + "<img src='./imgs/waiting.svg' alt='waiting...' />";
      return false;
   }

   function playerNotWaiting() {
      console.log("bom dia");
      document.getElementById("message_to_player").innerHTML = username + " has given up waiting...";
      return false;
   }
   ...
   function startGame() {
      ...
      if (document.getElementsByName("modo")[0].value === "2 Players") {
         ...
         timeElapsed = 0;
         document.getElementById("tempo").innerHTML = "Tempo decorrido: " + timeElapsed;
         document.getElementById("numero_minas").innerHTML = "Minas restantes:" + mines_counter;
   ...
   function placeMines() {
      ...
      while (placedMines !== mines) {
         ...
         if (matrix[r][c] !== -1) { // if theres no mine, place mine
            matrix[r][c] = -1;
            placedMines++;
   ...
   function leftClick(r, c) {
      ...
      if (visited[r][c] === false) {
         ...
         if (table.rows[r].cells[c].getElementsByTagName("img")[0].getAttribute("src") === "./imgs/blank.gif") {

            if (matrix[r][c] === -1) { //Game OVER!!!
   ...
   function burst(r, c) {
      if (table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/flag.png")) {
         increaseMines();
      }
   ...
   function chooseAndSetPicture(r, c, n) {
      switch (n) {
         case 0:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open0.gif");
            break;
         case 1:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open1.gif");
            break;
         case 2:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open2.gif");
            break;
         case 3:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open3.gif");
            break;
         case 4:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open4.gif");
            break;
         case 5:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open5.gif");
            break;
         case 6:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open6.gif");
            break;
         case 7:
         table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open7.gif");
            break;
         case 8:
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/open8.gif");
            break;
         default:
      }
   }
   ...
   function rightClick(r, c) {
      ...
      if (visited[r][c] === false) {
         ...
         if (   table.rows[r].cells[c].getElementsByTagName("img")[0].getAttribute("src")  === "./imgs/blank.gif") {
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/flag.png");
            decreaseMines();
         } else if (  table.rows[r].cells[c].getElementsByTagName("img")[0].getAttribute("src") === "./imgs/flag.png"){
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/questionmark.png");
            increaseMines();
         } else if (  table.rows[r].cells[c].getElementsByTagName("img")[0].getAttribute("src") === "./imgs/questionmark.png") {
            table.rows[r].cells[c].getElementsByTagName("img")[0].setAttribute("src","./imgs/blank.gif");
         }
   ...
   function showWhosTurn() {
      document.getElementById('whos_turn').innerHTML = "É o turno do jogador: " + turn;
   }
   ...
   function updatePlayersStats() {
      document.getElementById("player_stats").innerHTML = "Jogador " + username + " encontrou : " + p_bombs + " bombas";
      document.getElementById("opponent_stats").innerHTML = "Adversario " + opponent + " encontrou : " + op_bombs + " bombas";
      return false;
   }
   ...
   function refreshHonra() {
      ...
      for (var i = 0; i < showHonor.length; i++) {
         var node = document.createElement("li");
         var textnode = document.createTextNode(" " + showHonor[i].uname + " " + showHonor[i].score);
         node.appendChild(textnode);
         document.getElementById("honorlist").appendChild(node);
      }
